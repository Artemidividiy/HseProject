...
* мой НЕ ОРГАНАЙЗЕР отличается от всех вышеперечисленных также и тем, что в нем нет как таковых напоминаний для пользователя. Приложение только спрашивает пользователя насколько ответственно последний подошел к таску, а не напоминает про него. Суть этого приложения именно научить пользователя самостоятельности 
