...
import 'package:aimation/page/lock_screen.dart';
import 'package:aimation/page/profile_screen.dart';
import 'package:aimation/scopedmodel/todo_list_model.dart';
import 'package:aimation/gradient_background.dart';
import 'package:aimation/task_progress_indicator.dart';
import 'package:aimation/page/add_task_screen.dart';
import 'package:aimation/model/hero_id_model.dart';
import 'package:aimation/model/task_model.dart';
import 'package:aimation/route/scale_route.dart';
import 'package:aimation/utils/color_utils.dart';
import 'package:aimation/utils/datetime_utils.dart';
import 'package:aimation/page/detail_screen.dart';
import 'package:aimation/component/todo_badge.dart';
import 'package:aimation/page/privacy_policy.dart';
import 'package:aimation/model/data/choice_card.dart';
...
void _readPreviousDay() async {
  SharedPreferences _prefs = await SharedPreferences.getInstance();
  previousDate = _prefs.getDouble("lastCheckDate") ?? 0;
}
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              'You have ${_todos.where((todo) => todo.isCompleted == 0).length} tasks remaining',
...
void _savePreviousDate()async{
  SharedPreferences _prefs = await SharedPreferences.getInstance();
  await _prefs.setInt("lastCheckDate", DateTime.now().day);
}
