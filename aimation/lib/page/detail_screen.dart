...
import 'package:aimation/minor_data/user.dart';
...
import 'package:aimation/page/add_todo_screen.dart';
import 'package:aimation/page/edit_task_screen.dart';
...
class _DetailScreenState extends State<DetailScreen> with SingleTickerProviderStateMixin {
  ...
  void _readTodays() async{
    ...
    setState(() {
     this.today = _prefs.getDouble("todays") ?? 0; 
    });
  }

  void _saveTodays() async {
    SharedPreferences _prefs = await SharedPreferences.getInstance();
    await _prefs.setDouble("todays", today + 1);
  }
  ...
  void _readProgress() async {
    SharedPreferences _prefs = await SharedPreferences.getInstance();
    setState(() {
      this.tasksCompleted = _prefs.getInt("tasksCompleted") ?? 0;
    });
  }

  Future<Null> _saveProgress() async{
    SharedPreferences _prefs = await SharedPreferences.getInstance();
    await _prefs.setInt("tasksCompleted", tasksCompleted + 1);
  }
